# Unofficial Typst Joyner Document Format
...
Please see the Typst instructions to add the configuration machine-wide [here](https://github.com/typst/packages?tab=readme-ov-file#local-packages). Please feel free to submit the Typst JDF configuration to the Typst Universe as a Typst package.
